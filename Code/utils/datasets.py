...
class DataManager(object):
    ...
    def __init__(self, dataset_name='imdb', dataset_path=None, image_size=(48, 48)):
        ...
        # Set dataset path based on input or default paths
...
def get_labels(dataset_name):
    """Get labels for different datasets"""
...
def get_class_to_arg(dataset_name='fer2013'):
    """Get class to argument dictionary for different datasets"""
    if dataset_name == 'fer2013':
...
def split_imdb_data(ground_truth_data, validation_split=.2, do_shuffle=False):
    """Split imdb data into training and validation sets"""
